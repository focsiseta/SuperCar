function lightpassSetup(c){
    ...
    noLight.setUniform1Int("uFanalino",3)
    noLight.setUniform1Int("uDepthSX",4)
    noLight.setUniform1Int("uDepthDX",5)
 //   noLight.setUniform1Int("uDepthSX",3)
//    noLight.setUniform1Int("uDepthDX",4)
    ...
    noLight.setBindingFunction((shader,drawable) => {
        ...
        if(shape.hasTexture && shape.hasNormals && shape.hasIndices){
    ...
    noLight.perspectiveMatrix = projMatrix
    /*
